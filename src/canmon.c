...
inline int get_token_num(const char *str, const char *delim) 
{
...
inline char *_miss_delims_or_symbols(char *str, const char *delim,
    int type)
{
    char *s = str;
    int cond;
...
inline void _str_trim(char *str, const char *delim)
{
    char *s = str;
    int i, len = 0;
